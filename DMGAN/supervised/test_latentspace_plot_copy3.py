...
[q_errors1, r_adjs1, z_adjs1, z_true1, z_train1], name1 = pickle_load(description1)

# Swiss Roll
description2 = 'logs/hybrid_GAN_lin_res-Dz=0.01-R=1-Lat=1.5-Tv=0.01-d-sr-bc-gs-2018-02-04-metric_plus3.pkl'
[q_errors2, r_adjs2, z_adjs2, z_true2, z_train2], name2 = pickle_load(description2)

# Uniform Desk
description3 = 'logs/hybrid_GAN_lin_res-Dz=0.01-R=1-Lat=1.5-Tv=0.01-d-ud-bc-gs-2018-02-04-metric_plus3.pkl'
[q_errors3, r_adjs3, z_adjs3, z_true3, z_train3], name3 = pickle_load(description3)

# Uniform Square
description4 = 'logs/hybrid_GAN_lin_res-Dz=0.01-R=1-Lat=1.5-Tv=0.01-d-us-bc-gs-2018-02-04-metric_plus3.pkl'
[q_errors4, r_adjs4, z_adjs4, z_true4, z_train4], name4 = pickle_load(description4)

# Gaussian
description5 = 'logs/hybrid_GAN_lin_res-Dz=0.01-R=1-Lat=1.5-Tv=0.01-d-gs-bc-gs-2018-02-04-metric_plus3.pkl'
[q_errors5, r_adjs5, z_adjs5, z_true5, z_train5], name5 = pickle_load(description5)
...
params_one = {"color": '#988ED5', 'alpha': 0.9, 'linestyle': '--', "lw": 0.9,
              'marker': 's', 'mec': 'k', "markersize": 6, "mew": 0.6,
              }

# BELOW SEVEN OPERATIONAL INDICES
ax1.scatter(z_adjs1[:, 0], z_adjs1[:, 1], **params)
# ax1.plot(z_train1[:, 0], z_train1[:, 1], **params_one)
...
# ax2.plot(z_train2[:, 0], z_train2[:, 1], **params_one)
...
# ax3.plot(z_train3[:, 0], z_train3[:, 1], **params_one)
...
# ax4.plot(z_train4[:, 0], z_train4[:, 1], **params_one)
...
# ax5.plot(z_train5[:, 0], z_train5[:, 1], **params_one)
...
plt.savefig('{}/{}.png'.format('./historical_records', "Latent_Space_track_center_copy1"))
# plt.show()
